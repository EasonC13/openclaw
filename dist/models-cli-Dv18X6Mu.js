...
import { n as validateAnthropicSetupToken } from "./auth-token-DwU4T3jI.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureOpenClawModelsJson } = await import("./reply-wyWTjlY3.js").then((n) => n.pf);
