...
import { Ag as loadModelCatalog, B_ as resolveApiKeyForProvider, Ct as openUrl, Dn as DEFAULT_OAUTH_WARN_MS, En as maskApiKey, F as resolveModelRefFromString, G_ as shouldEnableShellEnvFallback, H_ as resolveEnvApiKey, Hg as readConfigFileSnapshotForWrite, Hv as resolveAuthProfileDisplayLabel, Ii as loadProviderUsageSummary, Ir as runEmbeddedPiAgent, J as getModelsCommandSecretTargetIds, Lg as createConfigIO, M as resolveConfiguredModelRef, Mg as shouldSuppressBuiltInModel, N as resolveDefaultModelForAgent, Ng as resolveOpenClawAgentDir, O as normalizeProviderId, On as buildAuthHealthSummary, Ov as DEFAULT_MODEL, R as resolvePluginProviders, R_ as getCustomProviderApiKey, Rg as loadConfig, Ri as formatUsageWindowSummary, T as modelKey, U_ as resolveUsableCustomProviderApiKey, V_ as resolveAwsSdkEnvVarName, W as withProgressTotals, W_ as getShellEnvAppliedKeys, Wg as setRuntimeConfigSnapshot, Z as resolveCommandSecretRefsViaGateway, b as buildModelAliasIndex, d as setAuthProfileOrder, do as describeFailoverError, f as upsertAuthProfile, hf as resolveModelWithRegistry, k as parseModelRef, kn as formatRemainingShort, kv as DEFAULT_PROVIDER, n as resolveAuthProfileOrder, nh as resolveSecretRefString, p as ensureAuthProfileStore, r as resolveProfileUnusableUntilForDisplay, t as resolveAuthProfileEligibility, u as listProfilesForProvider, v as resolveAuthStorePathForDisplay, vf as discoverAuthStorage, vv as isNonSecretApiKeyMarker, x as findNormalizedProviderValue, yf as discoverModels, z_ as hasUsableCustomProviderApiKey, zi as resolveUsageProviderId } from "./auth-profiles-Bhj7KY_0.js";
...
import { i as parseDurationMs } from "./search-manager-CXibZwMQ.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-C9bjSNnQ.js");
	const { ensureOpenClawModelsJson } = await import("./auth-profiles-Bhj7KY_0.js").then((n) => n.jg);
