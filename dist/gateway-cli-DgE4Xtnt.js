...
import { $c as validateDevicePairApproveParams, $f as normalizeSessionDeliveryFields, $h as disableTailscaleFunnel, $i as computeBackoff, $l as validateWizardNextParams, $n as verifyNodeToken, $p as cleanStaleLockFiles, $u as getActiveTaskCount, A as resolveAllowedModelRef, Ac as validateAgentsListParams, Ad as isRestartEnabled, Ag as loadModelCatalog, Ah as readGatewayTokenEnv, Ai as resolveAnnounceTargetFromKey, Al as validateSecretsResolveParams, An as applyVerboseOverride, Ao as formatDoctorNonInteractiveHint, Av as formatThinkingLevels, B as createPluginRuntime, Ba as buildOutboundSessionContext, Bc as validateConfigPatchParams, Bg as readBestEffortConfig, Bi as canonicalizeSpawnedByForAgent, Bl as validateSessionsUsageParams, Bn as getRemoteSkillEligibility, Bo as resolveCronStaggerMs, Bp as isGatewayMessageChannel, Br as waitForActiveEmbeddedRuns, Bs as resolveSystemRunApprovalRequestContext, C as isCliProvider, C_ as ensureControlUiAllowedOriginsForNonLoopbackBind, Cc as validateAgentParams, Cg as extractTextFromChatContent, Ch as authorizeWsControlUiGatewayConnect, Ci as getAgentRunContext, Cl as validateNodePendingAckParams, Cm as inspectPortUsage, Cn as runCliAgent, Cp as resolveAgentMainSessionKey, Cr as extractFileContentFromSource, Cs as isKnownSecretTargetId, Cu as ensureExecApprovals, D as normalizeModelSelection, Dc as validateAgentsFilesGetParams, Dg as registerUnhandledRejectionHandler, Dl as validatePollParams, Dm as formatPortDiagnostics, Do as cleanStaleGatewayProcessesSync, Dp as snapshotSessionOrigin, Ec as validateAgentsDeleteParams, El as validateNodeRenameParams, Ep as resolveMainSessionKeyFromConfig, Er as resolveInputFileLimits, Eu as mergeExecApprovalsSocketDefaults, Ev as normalizeSecretInput, F_ as resolveSubagentMaxConcurrent, Fc as validateChatHistoryParams, Fh as createAuthRateLimiter, Fi as applyModelOverrideToSessionEntry, Fl as validateSessionsListParams, Fo as writeRestartSentinel, Ft as resolveAssistantAvatarUrl, Fv as normalizeFastMode, G as formatHelpExamples, Gc as validateConnectParams, Gg as writeConfigFile, Gh as resolveClientIp, Gi as loadSessionEntry, Gl as validateTalkConfigParams, Gn as removeRemoteNodeInfo, Go as normalizeOptionalText$1, Gp as GATEWAY_CLIENT_CAPS, Gr as resolveFastModeState, Gs as matchSystemRunApprovalBinding, Hc as validateConfigSchemaLookupResult, Hf as loadSessionStore, Hg as readConfigFileSnapshotForWrite, Hh as isValidIPv4, Hi as listAgentsForGateway, Hl as validateSkillsInstallParams, Hn as recordRemoteNodeInfo, Hp as isWebchatClient, I as resolveSubagentConfiguredModelSelection, Ic as validateChatInjectParams, If as resolveAgentSessionDirs, Ig as migrateLegacyConfig, Ih as normalizeRateLimitClientIp, Ii as loadProviderUsageSummary, Il as validateSessionsPatchParams, In as getChannelActivity, Io as normalizeHttpWebhookUrl, Ir as runEmbeddedPiAgent, Iu as saveExecApprovals, Iv as normalizeReasoningLevel, Ja as resolveOutboundChannelPlugin, Jc as validateCronRemoveParams, Jh as resolveRequestClientIp, Ji as resolveSessionModelRef, Jl as validateUpdateRunParams, Jn as listNodePairing, Jp as GATEWAY_CLIENT_NAMES, Jr as resolveCronStyleNow, Js as toSystemRunApprovalMismatchError, K_ as getGlobalHookRunner, Ka as normalizeReplyPayloadsForDelivery, Kc as validateCronAddParams, Kd as isSilentReplyText, Kf as updateSessionStore, Kg as validateConfigObjectWithPlugins, Kh as resolveGatewayBindHost, Ki as pruneLegacyStoreKeys, Kl as validateTalkModeParams, Kn as setSkillsRemoteRegistry, Ko as normalizePayloadToSystemText, Kp as GATEWAY_CLIENT_IDS, Ks as missingSystemRunApprovalBinding, L as resolveThinkingDefault, Lc as validateChatSendParams, Lg as createConfigIO, Lh as isLocalishHost, Ll as validateSessionsPreviewParams, Lo as normalizeCronJobCreate, Lp as INTERNAL_MESSAGE_CHANNEL, Lt as resolveExecApprovalCommandDisplay, Lv as normalizeThinkLevel, M as resolveConfiguredModelRef, Ma as resolveSessionDeliveryTarget, Mc as validateChannelsLogoutParams, Mh as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, Ml as validateSendParams, Mm as rawDataToString, Mn as unbindThreadBindingsBySessionKey, Mr as isAbortRequestText, Mt as CONTROL_UI_AVATAR_PREFIX, N as resolveDefaultModelForAgent, N_ as buildTalkConfigResponse, Nc as validateChannelsStatusParams, Nh as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, Ni as resolveNestedAgentLane, Nl as validateSessionsCompactParams, Nm as cleanOldMedia, No as summarizeRestartSentinel, Nr as stopSubagentsForRequester, Nt as buildControlUiAvatarUrl, Oc as validateAgentsFilesListParams, Ol as validatePushTestParams, Or as normalizeSendPolicy, Ou as normalizeExecApprovals, Ov as DEFAULT_MODEL, P as resolveHooksGmailModel, P_ as resolveAgentMaxConcurrent, Pc as validateChatAbortParams, Pd as ToolInputError, Ph as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, Pi as resolvePreferredSessionKeyForSessionIdMatches, Pl as validateSessionsDeleteParams, Pt as normalizeControlUiBasePath, Pv as normalizeElevatedLevel, Qa as buildChannelUiCatalog, Qc as validateCronUpdateParams, Qf as mergeDeliveryContext, Qg as parseByteSize, Qh as safeEqualSecret, Ql as validateWizardCancelParams, Qm as resolveConfiguredSecretInputString, Qn as updatePairedNodeMetadata, Qr as buildDefaultToolPolicyPipelineSteps, Qs as isSystemEventContextChanged, Qu as enqueueCommandInLane, Rc as validateConfigApplyParams, Rf as extractDeliveryInfo, Rg as loadConfig, Rh as isLoopbackAddress, Rl as validateSessionsResetParams, Ro as normalizeCronJobPatch, Rp as isDeliverableMessageChannel, Rr as abortEmbeddedPiRun, Rt as sanitizeExecApprovalDisplayText, Ru as getPluginToolMeta, Rv as normalizeUsageDisplay, S as getModelRefStatus, S_ as applyLegacyMigrations, Sc as validateAgentIdentityParams, Sh as authorizeHttpGatewayConnect, Si as emitAgentEvent, Sl as validateNodePairVerifyParams, Sm as ensurePortAvailable, Sn as setCliSessionId, Sp as canonicalizeMainSessionAlias, Sr as DEFAULT_INPUT_TIMEOUT_MS, Tc as validateAgentsCreateParams, Tg as SsrFBlockedError, Th as resolveGatewayAuth, Ti as registerAgentRunContext, Tl as validateNodePendingEnqueueParams, Tn as resolveSessionAuthProfileOverride, Tp as resolveMainSessionKey, Tr as normalizeMimeList, U as withProgress, Uc as validateConfigSchemaParams, Ug as resolveConfigSnapshotHash, Uh as normalizeHostHeader, Ui as listSessionsFromStore, Ul as validateSkillsStatusParams, Un as refreshRemoteBinsForConnectedNodes, Uo as normalizeOptionalAgentId, Up as normalizeMessageChannel, Us as resolveSystemRunCommandRequest, Ut as resolveAgentAvatar, Va as deliverOutboundPayloads, Vc as validateConfigSchemaLookupParams, Vf as archiveRemovedSessionTranscripts, Vg as readConfigFileSnapshot, Vh as isTrustedProxyAddress, Vl as validateSkillsBinsParams, Vn as primeRemoteSkillsCache, Vo as resolveDefaultCronStaggerMs, Vr as waitForEmbeddedPiRunEnd, Vs as resolveSystemRunApprovalRuntimeContext, Vv as supportsXHighThinking, Wc as validateConfigSetParams, Wd as SILENT_REPLY_TOKEN, Wh as pickPrimaryLanIPv4, Wi as loadCombinedSessionStoreForGateway, Wl as validateSkillsUpdateParams, Wn as refreshRemoteNodeBins, Wo as normalizeOptionalSessionKey, Wr as resolveBootstrapWarningSignaturesSeen, Ws as buildSystemRunApprovalBinding, Xc as validateCronRunsParams, Xh as pickPrimaryTailnetIPv4, Xl as validateWebLoginStartParams, Xm as mergeGatewayAuthConfig, Xn as renamePairedNode, Xo as normalizeLegacyDeliveryInput, Xp as normalizeGatewayClientMode, Xr as resolveToolLoopDetectionConfig, Xt as buildHistoryContextFromEntries, Xu as clearBootstrapSnapshot, Ya as applyPluginAutoEnable, Yc as validateCronRunParams, Yl as validateWakeParams, Ym as ensureGatewayStartupAuth, Yn as rejectNodePairing, Yo as parseAbsoluteTimeMs, Yp as hasGatewayClientCap, Yt as createReplyPrefixOptions, Zc as validateCronStatusParams, Zd as resolveAgentIdentity, Zf as deliveryContextFromSession, Zh as pickPrimaryTailnetIPv6, Zi as lookupContextTokens, Zl as validateWebLoginWaitParams, Zm as mergeGatewayTailscaleConfig, Zn as requestNodePairing, Zr as applyToolPolicyPipeline, Zs as enqueueSystemEvent, Zu as clearBootstrapSnapshotOnSessionRollover, _a as readChannelAllowFromStoreSync, _c as WRITE_SCOPE, _d as getMachineDisplayName, _i as resolveAgentTimeoutMs, _l as validateNodeListParams, _n as buildBareSessionResetPrompt, _o as markGatewaySigusr1RestartHandled, _p as resolveSessionResetPolicy, _r as registerSkillsChangeListener, _s as prepareSecretsRuntimeSnapshot, _u as publicKeyRawBase64UrlFromPem, a_ as isAvatarHttpUrl, ac as setHeartbeatsEnabled, ad as waitForActiveTasks, af as resolveTtsAutoMode, ai as runBeforeToolCallHook, al as validateExecApprovalRequestParams, ao as normalizePollInput, ap as readSessionMessages, ar as listAgentWorkspaceDirs, au as ConnectErrorDetailCodes, bd as stripHeartbeatToken, bi as resolveIngressWorkspaceOverrideForSpawnedRun, bl as validateNodePairRejectParams, bm as movePathToTrash, bn as saveCronStore, bo as setPreRestartDeferralCheck, br as DEFAULT_INPUT_IMAGE_MAX_BYTES, bs as evaluateGatewayAuthSurfaceStates, bu as buildExecApprovalPendingReplyPayload, cc as callGateway, cd as startDiagnosticHeartbeat, cf as resolveTtsProviderOrder, cl as validateExecApprovalsNodeGetParams, cp as stripEnvelopeFromMessage, cs as detectSuspiciousPatterns, cu as buildDeviceAuthPayload, dd as isDiagnosticsEnabled, df as textToSpeech, dg as mergeAlsoAllowPolicy, dl as validateLogsTailParams, dp as stripInlineDirectiveTagsFromMessageForDisplay, ds as closeTrackedBrowserTabsForSessions, ea as sleepWithAbort, eg as disableTailscaleServe, el as validateDevicePairListParams, em as isPidAlive, eu as validateWizardStartParams, fa as ensureOutboundSessionEntry, ff as OPENAI_TTS_MODELS, fg as resolveToolProfilePolicy, fi as listDescendantRunsForRequester, fl as validateModelsListParams, fo as resolveFailoverReasonFromError, fp as normalizeInputProvenance, fs as applyBrowserProxyPaths, fu as normalizeDeviceAuthScopes, gd as resolveMemorySearchConfig, gg as resolveCoreToolProfiles, gl as validateNodeInvokeResultParams, gm as startBrowserControlServiceFromConfig, go as isGatewaySigusr1RestartExternallyAllowed, gr as getSkillsSnapshotVersion, gs as getActiveSecretsRuntimeSnapshot, gu as normalizeDevicePublicKeyBase64Url, hc as PAIRING_SCOPE$1, hg as listCoreToolSections, hl as validateNodeInvokeParams, hm as createBrowserControlContext, hn as getTotalPendingReplies, ho as emitGatewayRestart, hp as evaluateSessionFreshness, hs as clearSecretsRuntimeSnapshot, hu as loadOrCreateDeviceIdentity, i_ as AVATAR_MAX_BYTES, ia as normalizeGroupActivation, id as setCommandLaneConcurrency, if as resolveTtsApiKey, ig as getTailnetHostname, il as validateDeviceTokenRotateParams, io as resolveMessageChannelSelection, ip as cleanupArchivedSessionTranscripts, it as resolveAgentOutboundIdentity, iu as parseSessionLabel, ja as resolveOutboundTarget, jc as validateAgentsUpdateParams, jl as validateSecretsResolveResult, jn as parseVerboseOverride, jo as formatRestartSentinelMessage, ju as readExecApprovalsSnapshot, jv as formatXHighModelHint, kc as validateAgentsFilesSetParams, kf as estimateBase64DecodedBytes, kh as readGatewayPasswordEnv, ki as readLatestAssistantReply, kl as validateRequestFrame, ko as consumeRestartSentinel, kr as resolveSendPolicy, kv as DEFAULT_PROVIDER, ld as stopDiagnosticHeartbeat, lf as setTtsEnabled, ll as validateExecApprovalsNodeSetParams, lp as stripEnvelopeFromMessages, ls as getHookType, lu as buildDeviceAuthPayloadV3, mc as APPROVALS_SCOPE$1, ml as validateNodeEventParams, mm as createBrowserRouteDispatcher, mn as createReplyDispatcher, mo as deferGatewayRestartUntilIdle, ms as activateSecretsRuntimeSnapshot, mu as deriveDeviceIdFromPublicKey, na as clearSessionQueues, nd as markGatewayDraining, nf as isTtsEnabled, ng as enableTailscaleServe, ni as resolveGroupToolPolicy, nl as validateDevicePairRemoveParams, nm as readJsonFile, no as resetDirectoryCache, np as archiveSessionTranscripts, nt as buildTelegramExecApprovalButtons, nu as ErrorCodes, o_ as isAvatarImageDataUrl, od as CommandLane, of as resolveTtsConfig, oi as createOpenClawTools, ol as validateExecApprovalResolveParams, on as sendTypingTelegram, op as readSessionPreviewItemsFromTranscript, or as formatZonedTimestamp, ot as handleSlackHttpRequest, ou as resolveAuthConnectErrorDetailCode, pa as resolveOutboundSessionRoute, pc as ADMIN_SCOPE$3, pf as OPENAI_TTS_VOICES, pg as PROFILE_OPTIONS, pl as validateNodeDescribeParams, pn as dispatchInboundMessage, po as consumeGatewaySigusr1RestartAuthorization, pp as jsonUtf8Bytes, ps as persistBrowserProxyFiles, pu as loadGatewayTlsRuntime$1, q_ as runGlobalGatewayStopSafely, qc as validateCronListParams, qg as OpenClawSchema, qh as resolveGatewayListenHosts, qi as resolveGatewaySessionStoreTarget, ql as validateToolsCatalogParams, qn as approveNodePairing, qo as normalizeRequiredName, qp as GATEWAY_CLIENT_MODES, rc as requestHeartbeatNow, rd as resetAllLanes, rf as isTtsProviderConfigured, ri as resolveSubagentToolPolicy, rl as validateDeviceTokenRevokeParams, rm as writeJsonAtomic, rp as capArrayByJsonBytes, ru as errorShape, s_ as looksLikeAvatarPath, sf as resolveTtsPrefsPath, si as countActiveDescendantRuns, sl as validateExecApprovalsGetParams, so as runWithModelFallback, sp as resolveSessionTranscriptCandidates, ss as buildSafeExternalPrompt, su as resolveDeviceAuthConnectErrorDetailCode, td as getTotalQueueSize, tf as getTtsProvider, tg as enableTailscaleFunnel, ti as resolveEffectiveToolPolicy, tl as validateDevicePairRejectParams, tm as createAsyncLock, to as maybeResolveIdLikeTarget, tp as archiveFileOnDisk, tu as validateWizardStatusParams, uf as setTtsProvider, ug as collectExplicitAllowlist, ui as initSubagentRegistry, ul as validateExecApprovalsSetParams, up as stripInlineDirectiveTagsForDisplay, us as isExternalHookSession, uu as normalizeDeviceMetadataForAuth, vc as authorizeOperatorScopesForMethod, vl as validateNodePairApproveParams, vn as loadCronStore, vo as scheduleGatewaySigusr1Restart, vs as resolveCommandSecretsFromActiveRuntimeSnapshot, wc as validateAgentWaitParams, wg as fetchWithSsrFGuard, wh as isLocalDirectRequest, wi as onAgentEvent, wl as validateNodePendingDrainParams, wp as resolveExplicitAgentSessionKey, wr as extractImageContentFromSource, x_ as applyMergePatch, xc as formatValidationErrors, xd as getAcpSessionManager, xh as assertGatewayAuthConfigured, xi as clearAgentRunContext, xl as validateNodePairRequestParams, xn as getCliSessionId, xo as triggerOpenClawRestart, xp as setSessionRuntimeModel, xr as DEFAULT_INPUT_IMAGE_MIMES, xu as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, y as buildAllowedModelSet, yc as isNodeRoleMethod, yi as normalizeSpawnedRunMetadata, yl as validateNodePairListParams, yn as resolveCronStorePath, yo as setGatewaySigusr1RestartPolicy, yp as mergeSessionEntry, ys as GATEWAY_AUTH_SURFACE_PATHS, yt as handleReset, yu as verifyDeviceSignature, z as loadOpenClawPlugins, zc as validateConfigGetParams, zd as resolveUserTimezone, zf as parseSessionThreadInfo, zg as parseConfigJson5, zh as isLoopbackHost, zl as validateSessionsResolveParams, zo as normalizeCronStaggerMs, zp as isGatewayCliClient, zr as getActiveEmbeddedRunCount, zu as resolvePluginTools, zv as normalizeVerboseLevel } from "./auth-profiles-Bhj7KY_0.js";
...
import { T as isTestDefaultMemorySlotDisabled, i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-B3A7AH0T.js";
...
import { i as parseDurationMs, r as resolveMemoryBackendConfig, t as getMemorySearchManager } from "./search-manager-CXibZwMQ.js";
...
import { t as buildWorkspaceSkillStatus } from "./skills-status-CTUuvc0P.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BzNLLxfG.js";
import { t as isWithinDir } from "./path-safety-CmNS4Puh.js";
import "./install-safe-path-D-MWaGBf.js";
import "./skill-scanner-CREeAGqo.js";
import { n as formatConfigIssueLines } from "./issue-format-BamxR_FI.js";
import { t as buildChannelAccountSnapshot } from "./status-DxgZXSBm.js";
import "./channels-status-issues-BMEgAbeb.js";
import { n as verifyDeviceBootstrapToken } from "./device-bootstrap-C-2sNhau.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-CTBJx9qv.js";
...
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-DIo3FzX0.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-v1nUkiTq.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-BVQl32im.js";
import { a as styleHealthChannelLine, c as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-E1kYF2ug.js";
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-DwzO3Inn.js";
...
import { f as normalizeStoredCronJobs, h as computePreviousRunAtMs, m as computeNextRunAtMs, p as coerceFiniteScheduleNumber, t as runGatewayUpdate } from "./update-runner-CntNvESW.js";
import { a as resolveAgentOutboundTarget, i as resolveAgentDeliveryPlan, n as agentCommandFromIngress } from "./agent-vFSxzS4l.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-CtSI1cMQ.js";
import { _ as resolveHookTargetAgentId, a as getHookAgentPolicyError, b as resolveFunctionModuleExport, c as normalizeAgentPayload, d as normalizeWakePayload, f as readJsonBody, g as resolveHookSessionKey, h as resolveHookIdempotencyKey, i as extractHookToken, l as normalizeHookDispatchSessionKey, m as resolveHookDeliver, n as collectEnabledInsecureOrDangerousFlags, o as getHookChannelError, p as resolveHookChannel, s as isHookAgentAllowed, u as normalizeHookHeaders, v as resolveHooksConfig, y as applyHookMappings } from "./audit-CMghUhoK.js";
import "./node-service-BtiiN7rY.js";
import "./status.update-B8-0XVxZ.js";
import { t as installSkill } from "./skills-install-BORDsqFB.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-B7kkb03s.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-UEV-tkL-.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CNXIpzO5.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-CCxmVE_A.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./auth-profiles-Bhj7KY_0.js").then((n) => n.Ha);
