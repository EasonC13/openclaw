...
import { t as loginOpenAICodexOAuth } from "./openai-codex-oauth-BWQtf93F.js";
import { n as validateAnthropicSetupToken } from "./auth-token-CNTVZovL.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureOpenClawModelsJson } = await import("./auth-profiles-GWyaossq.js").then((n) => n.wg);
