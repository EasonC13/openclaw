...
import { Dt as resolveControlUiLinks, Et as randomToken, Gg as writeConfigFile, Vg as readConfigFileSnapshot, ft as DEFAULT_WORKSPACE, gt as ensureWorkspaceAndSessions, jt as waitForGatewayReachable, pt as applyWizardMetadata, xt as normalizeGatewayTokenInput, yt as handleReset } from "./auth-profiles-Bhj7KY_0.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-8xXNrLZ2.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CocbYUcP.js");
