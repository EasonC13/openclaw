...
import { i as parseDurationMs, r as resolveMemoryBackendConfig, t as getMemorySearchManager } from "./search-manager-D_I-ywR5.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BaMS7MRU.js";
import { t as isWithinDir } from "./path-safety-Z97FO1K-.js";
import "./install-safe-path-DZM2JHcC.js";
import "./skill-scanner-Ms0uZYdw.js";
import { n as formatConfigIssueLines } from "./issue-format-D64Uu-uk.js";
import { t as buildChannelAccountSnapshot } from "./status-B2nu9TUx.js";
import "./channels-status-issues-D0D1GN5e.js";
import { n as verifyDeviceBootstrapToken } from "./device-bootstrap-BVo9vDdJ.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-BinjUTGq.js";
...
import { t as discoverGatewayBeacons } from "./bonjour-discovery-DhYQYOtu.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-D26abAi2.js";
import { a as styleHealthChannelLine, c as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-XTGpZezP.js";
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-BK7Opgx0.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DqprmmyZ.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-C2p0VnW3.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./auth-profiles-GWyaossq.js").then((n) => n.Wa);
