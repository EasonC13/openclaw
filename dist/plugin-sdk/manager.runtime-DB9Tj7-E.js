...
import { Ai as readConfigFileSnapshotForWrite, At as hasNonzeroUsage, Bi as normalizeVerboseLevel, Bn as isSilentReplyText, Cn as getAcpSessionManager, Ct as resolveAcpSessionCwd, Dt as AGENT_LANE_SUBAGENT, Et as AGENT_LANE_NESTED, Fi as DEFAULT_MODEL, Ft as normalizeReplyPayload, G as applyVerboseOverride, H as setCliSessionId, Ii as DEFAULT_PROVIDER, Jn as parseTtsDirectives, Jr as isDeliverableMessageChannel, Jt as resolveOutboundTarget, Kn as resolveTtsConfig, Kt as resolveAgentRoute, Li as formatThinkingLevels, Oi as loadModelCatalog, Ot as applyModelOverrideToSessionEntry, Q as getSkillsSnapshotVersion, Qr as resolveMessageChannel, Ri as formatXHighModelHint, Sr as normalizeChannelId, St as registerAgentRunContext, T as isDangerousNameMatchingEnabled, Ti as formatErrorMessage, Tt as resolveAcpDispatchPolicyError, U as runCliAgent, Ui as formatCliCommand, V as getCliSessionId, Vi as supportsXHighThinking, W as clearSessionAuthProfileOverride, Xr as isInternalMessageChannel, Xt as resolveDiscordOwnerAccess, Yr as isGatewayMessageChannel, Yt as resolveSessionDeliveryTarget, Z as getRemoteSkillEligibility, Zr as normalizeMessageChannel, Zt as formatDiscordUserTag, _r as resolveSessionResetType, _t as resolveAgentTimeoutMs, a as normalizeModelRef, an as deliverOutboundPayloads, at as runEmbeddedPiAgent, bi as buildWorkspaceSkillSnapshot, br as resolveExplicitAgentSessionKey, bt as clearAgentRunContext, c as resolveDefaultModelForAgent, cn as normalizeOutboundPayloadsForJson, cr as loadSessionStore, d as resolveCommandSecretRefsViaGateway, dn as resolveMessageChannelSelection, dr as updateSessionStore, er as buildProviderRegistry, et as resolveSendPolicy, fr as normalizeAccountId, gr as resolveSessionResetPolicy, hn as FailoverError, hr as resolveChannelResetConfig, i as modelKey, in as buildOutboundSessionContext, ir as runCapability, ji as setRuntimeConfigSnapshot, jt as resolveContextTokensForModel, ki as loadConfig, kt as deriveSessionTotalTokens, l as resolveThinkingDefault, mr as evaluateSessionFreshness, n as buildAllowedModelSet, nr as normalizeMediaAttachments, o as normalizeProviderId, on as formatOutboundPayloadLog, or as resolveSessionTranscriptFile, ot as prepareSessionManagerForRun, pn as runWithModelFallback, pr as resolveSessionKey, q as formatMention, qn as textToSpeech, qr as INTERNAL_MESSAGE_CHANNEL, r as isCliProvider, s as resolveConfiguredModelRef, sn as normalizeOutboundPayloads, sr as emitSessionTranscriptUpdate, st as resolveBootstrapWarningSignaturesSeen, t as ensureAuthProfileStore, tr as createMediaAttachmentCache, u as getAgentRuntimeCommandSecretTargetIds, vn as clearBootstrapSnapshotOnSessionRollover, vr as mergeSessionEntry, vt as formatAgentInternalEventsForPrompt, wn as toAcpRuntimeError, wt as resolveAcpAgentPolicyError, xr as getChannelPlugin, xt as emitAgentEvent, yr as setSessionRuntimeModel, yt as normalizeSpawnedRunMetadata, zi as normalizeThinkLevel, zn as isSilentReplyPrefixText } from "./model-auth-CARJcRIv.js";
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, _n as resolveAgentIdFromSessionKey, gn as normalizeMainKey, gt as listAgentIds, hn as normalizeAgentId, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-D3ZCNXAX.js";
import { B as shouldLogVerbose, M as defaultRuntime, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./logger-CYwRgFF1.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-BD0ft_w-.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-QM3zErnl.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-ByQALZZc.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-CkhvEAXR.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-C1wnksm1.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-CERF7rbv.js");
