...
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, _n as resolveAgentIdFromSessionKey, gn as normalizeMainKey, gt as listAgentIds, hn as normalizeAgentId, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-BdUD9VUq.js";
import { $n as resolveSessionResetPolicy, $r as normalizeThinkLevel, An as textToSpeech, B as clearSessionAuthProfileOverride, Ct as AGENT_LANE_SUBAGENT, Dt as resolveContextTokensForModel, Et as hasNonzeroUsage, Fr as buildWorkspaceSkillSnapshot, Gn as loadSessionStore, Gr as setRuntimeConfigSnapshot, Gt as buildOutboundSessionContext, Hr as loadModelCatalog, Ht as resolveSessionDeliveryTarget, J as getSkillsSnapshotVersion, Jn as updateSessionStore, Jt as normalizeOutboundPayloads, Kt as deliverOutboundPayloads, L as getCliSessionId, Ln as buildProviderRegistry, Qn as resolveChannelResetConfig, Qr as formatXHighModelHint, Qt as resolveMessageChannelSelection, R as setCliSessionId, Rn as createMediaAttachmentCache, Sn as isSilentReplyText, St as AGENT_LANE_NESTED, Tt as deriveSessionTotalTokens, U as formatMention, Un as resolveSessionTranscriptFile, Ur as loadConfig, Ut as resolveDiscordOwnerAccess, V as applyVerboseOverride, Vn as runCapability, Vt as resolveOutboundTarget, Wn as emitSessionTranscriptUpdate, Wr as readConfigFileSnapshotForWrite, Wt as formatDiscordUserTag, X as resolveSendPolicy, Xi as formatCliCommand, Xn as resolveSessionKey, Xr as DEFAULT_PROVIDER, Yn as normalizeAccountId, Yr as DEFAULT_MODEL, Yt as normalizeOutboundPayloadsForJson, Zn as evaluateSessionFreshness, Zr as formatThinkingLevels, _t as emitAgentEvent, a as normalizeModelRef, an as clearBootstrapSnapshotOnSessionRollover, ar as normalizeChannelId, bt as resolveAcpAgentPolicyError, c as resolveDefaultModelForAgent, cr as INTERNAL_MESSAGE_CHANNEL, d as resolveCommandSecretRefsViaGateway, dn as toAcpRuntimeError, dr as isInternalMessageChannel, ei as normalizeVerboseLevel, en as runWithModelFallback, er as resolveSessionResetType, fr as normalizeMessageChannel, gt as clearAgentRunContext, ht as normalizeSpawnedRunMetadata, i as modelKey, ir as getChannelPlugin, jn as parseTtsDirectives, jt as normalizeReplyPayload, kn as resolveTtsConfig, l as resolveThinkingDefault, lr as isDeliverableMessageChannel, mt as formatAgentInternalEventsForPrompt, n as buildAllowedModelSet, nn as FailoverError, nr as setSessionRuntimeModel, nt as prepareSessionManagerForRun, o as normalizeProviderId, pr as resolveMessageChannel, pt as resolveAgentTimeoutMs, q as getRemoteSkillEligibility, qt as formatOutboundPayloadLog, r as isCliProvider, rr as resolveExplicitAgentSessionKey, rt as resolveBootstrapWarningSignaturesSeen, s as resolveConfiguredModelRef, t as ensureAuthProfileStore, ti as supportsXHighThinking, tr as mergeSessionEntry, tt as runEmbeddedPiAgent, u as getAgentRuntimeCommandSecretTargetIds, un as getAcpSessionManager, ur as isGatewayMessageChannel, vt as registerAgentRunContext, wt as applyModelOverrideToSessionEntry, x as isDangerousNameMatchingEnabled, xn as isSilentReplyPrefixText, xt as resolveAcpDispatchPolicyError, yt as resolveAcpSessionCwd, z as runCliAgent, zn as normalizeMediaAttachments, zr as formatErrorMessage, zt as resolveAgentRoute } from "./model-auth-DNbhQmRn.js";
import { B as shouldLogVerbose, M as defaultRuntime, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./logger-DPWRMI9x.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-DVp1LUXe.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-DFMtD6FU.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-VJqMlz8p.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-BjlEJRTy.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-CwdCVuiI.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-BMxfe7z6.js");
