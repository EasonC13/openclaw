...
import { $ as formatMention, Ai as getChannelPlugin, At as applyModelOverrideToSessionEntry, Bn as textToSpeech, Cr as isGatewayMessageChannel, Ct as emitAgentEvent, D as isDangerousNameMatchingEnabled, Dt as resolveAcpDispatchPolicyError, Er as resolveMessageChannel, Et as resolveAcpAgentPolicyError, Gt as resolveAgentRoute, J as runCliAgent, Jn as createMediaAttachmentCache, Jt as resolveSessionDeliveryTarget, K as getCliSessionId, Lt as normalizeReplyPayload, Mn as isSilentReplyPrefixText, Mt as hasNonzeroUsage, Nn as isSilentReplyText, Nt as resolveContextTokensForModel, Ot as AGENT_LANE_NESTED, Si as buildWorkspaceSkillSnapshot, Sn as toAcpRuntimeError, Sr as isDeliverableMessageChannel, St as clearAgentRunContext, Tr as normalizeMessageChannel, Tt as resolveAcpSessionCwd, Ur as formatErrorMessage, Vn as parseTtsDirectives, X as clearSessionAuthProfileOverride, Xt as formatDiscordUserTag, Yn as normalizeMediaAttachments, Yt as resolveDiscordOwnerAccess, Z as applyVerboseOverride, Zn as runCapability, _r as setSessionRuntimeModel, an as normalizeOutboundPayloads, ar as loadSessionStore, bi as getRemoteSkillEligibility, bt as formatAgentInternalEventsForPrompt, c as isCliProvider, cr as updateSessionStore, ct as prepareSessionManagerForRun, d as normalizeProviderId, di as ensureAuthProfileStore, dr as resolveSessionKey, f as resolveConfiguredModelRef, fi as formatThinkingLevels, fn as runWithModelFallback, fr as evaluateSessionFreshness, g as resolveCommandSecretRefsViaGateway, gi as supportsXHighThinking, gn as clearBootstrapSnapshotOnSessionRollover, gr as mergeSessionEntry, h as getAgentRuntimeCommandSecretTargetIds, hi as normalizeVerboseLevel, hr as resolveSessionResetType, ii as setRuntimeConfigSnapshot, in as formatOutboundPayloadLog, ir as emitSessionTranscriptUpdate, it as resolveSendPolicy, ji as normalizeChannelId, jt as deriveSessionTotalTokens, kt as AGENT_LANE_SUBAGENT, l as modelKey, lt as resolveBootstrapWarningSignaturesSeen, m as resolveThinkingDefault, mi as normalizeThinkLevel, mr as resolveSessionResetPolicy, ni as loadConfig, nn as buildOutboundSessionContext, nr as loadModelCatalog, on as normalizeOutboundPayloadsForJson, p as resolveDefaultModelForAgent, pi as formatXHighModelHint, pn as FailoverError, pr as resolveChannelResetConfig, q as setCliSessionId, qn as buildProviderRegistry, qt as resolveOutboundTarget, ri as readConfigFileSnapshotForWrite, rn as deliverOutboundPayloads, rr as resolveSessionTranscriptFile, s as buildAllowedModelSet, st as runEmbeddedPiAgent, ta as formatCliCommand, u as normalizeModelRef, un as resolveMessageChannelSelection, ur as normalizeAccountId, vi as DEFAULT_MODEL, vr as resolveExplicitAgentSessionKey, wr as isInternalMessageChannel, wt as registerAgentRunContext, xi as getSkillsSnapshotVersion, xn as getAcpSessionManager, xr as INTERNAL_MESSAGE_CHANNEL, xt as normalizeSpawnedRunMetadata, yi as DEFAULT_PROVIDER, yt as resolveAgentTimeoutMs, zn as resolveTtsConfig } from "./skill-commands-D1OoGV-s.js";
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, fn as normalizeAgentId, gt as listAgentIds, mn as resolveAgentIdFromSessionKey, pn as normalizeMainKey, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-B7LXgibx.js";
import "./paths-DBpXUsXY.js";
import { B as shouldLogVerbose, M as defaultRuntime, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./logger-ckwEI4wR.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-DG8ytSxg.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-ByGdw4Ln.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-DMd3Sowy.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-CfmHKeFT.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-BWZgd1NF.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-fbQkYo9Z.js");
