import { A as theme, O as colorize, p as defaultRuntime } from "./subsystem-DVwhOlEq.js";
import { d as resolveIsNixMode, g as resolveStateDir } from "./paths-BfR2LXbA.js";
import "./boolean-BHdNsbzF.js";
import { Cu as ensureExecApprovals, Eu as mergeExecApprovalsSocketDefaults, G as formatHelpExamples, Gu as evaluateExecAllowlist, Hs as formatExecCommand, Iu as saveExecApprovals, Jp as GATEWAY_CLIENT_NAMES, Ku as evaluateShellAllowlist, Lu as requestJsonlSocket, Mu as recordAllowlistUse, Nu as requiresExecApproval, Ou as normalizeExecApprovals, Pu as resolveExecApprovals, Rg as loadConfig, Su as addAllowlistEntry, Us as resolveSystemRunCommandRequest, Uu as resolveExecSafeBinRuntimePolicy, Vu as isInterpreterLikeSafeBin, Yr as withTimeout, __ as unwrapKnownDispatchWrapperInvocation, _d as getMachineDisplayName, b_ as resolveInlineCommandMatch, bc as GatewayClient, d_ as analyzeArgvCommand, f_ as resolvePlannedSegmentArgv, g_ as normalizeExecutableToken, gm as startBrowserControlServiceFromConfig, h_ as POSIX_SHELL_WRAPPERS, hm as createBrowserControlContext, hu as loadOrCreateDeviceIdentity, ju as readExecApprovalsSnapshot, km as resolveBrowserConfig, m_ as resolveExecutableFromPathEnv, mm as createBrowserRouteDispatcher, p_ as resolveCommandResolutionFromArgv, qp as GATEWAY_CLIENT_MODES, qs as normalizeSystemRunApprovalPlan, qu as resolveAllowAlwaysPatterns, rm as writeJsonAtomic, v_ as unwrapKnownShellMultiplexerInvocation, y_ as POSIX_INLINE_COMMAND_FLAGS, zt as resolveGatewayConnectionAuth } from "./auth-profiles-Bhj7KY_0.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { i as resolveAgentConfig } from "./agent-scope-DBEC2O3x.js";
...
import { S as sanitizeSystemRunEnvOverrides, x as sanitizeHostExecEnv } from "./env-overrides-DWoj3eoQ.js";
import { t as VERSION } from "./version-N--ZkDj4.js";
import { a as splitShellArgs } from "./search-manager-CXibZwMQ.js";
import "./plugins-BKDaOrHv.js";
import { W as detectMime } from "./query-expansion-kdDusy7Q.js";
...
import { b as resolveNodeSystemdServiceName, f as formatNodeServiceDescription, x as resolveNodeWindowsTaskName, y as resolveNodeLaunchAgentLabel } from "./prompt-style-2BF77KhS.js";
...
import { l as buildNodeServiceEnvironment, n as resolveDaemonInstallRuntimeInputs, p as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-UU_0Zlnr.js";
...
import { a as createCliStatusTextStyles, f as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, h as createDaemonActionContext, i as runServiceUninstall, m as buildDaemonServiceSnapshot, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-D5nYJc_I.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-CfbCojFh.js";
import { t as parsePort } from "./parse-port-CS-89LRy.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-BzA-O1q7.js";
import { t as resolveNodeService } from "./node-service-BtiiN7rY.js";
