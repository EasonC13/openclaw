...
import { Am as GATEWAY_CLIENT_NAMES, Hs as buildGatewayConnectionDetails, Ig as isKnownCoreToolId, Ut as resolveGatewayConnectionAuth, Yv as listThinkingLevels, b_ as loadConfig, bv as VERSION, km as GATEWAY_CLIENT_MODES, tc as GatewayClient } from "./reply-DCmI6_Pe.js";
...
import { M as resolveWindowsSpawnProgram, j as materializeWindowsSpawnProgram } from "./query-expansion-yWVZ1kDa.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-Bwp7jkBY.js");
