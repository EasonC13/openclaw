...
import { Dt as randomToken, Mt as waitForGatewayReachable, Ot as resolveControlUiLinks, Pg as readConfigFileSnapshot, Rg as writeConfigFile, St as normalizeGatewayTokenInput, _t as ensureWorkspaceAndSessions, bt as handleReset, mt as applyWizardMetadata, pt as DEFAULT_WORKSPACE } from "./auth-profiles-GWyaossq.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Cc61xMGZ.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-zzXMCqYa.js");
