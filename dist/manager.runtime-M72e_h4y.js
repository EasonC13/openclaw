...
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, fn as normalizeAgentId, gt as listAgentIds, mn as resolveAgentIdFromSessionKey, pn as normalizeMainKey, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-DKeQBH10.js";
import "./paths-DinMprTu.js";
import { B as shouldLogVerbose, M as defaultRuntime, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./logger-D_11x3rk.js";
import { At as normalizeReplyPayload, B as applyVerboseOverride, Bn as buildProviderRegistry, Bt as resolveOutboundTarget, Ct as applyModelOverrideToSessionEntry, Dn as isSilentReplyPrefixText, Ei as DEFAULT_PROVIDER, Et as resolveContextTokensForModel, Fr as isDeliverableMessageChannel, H as formatMention, Hn as normalizeMediaAttachments, Ht as resolveDiscordOwnerAccess, I as getCliSessionId, Ir as isGatewayMessageChannel, Jt as deliverOutboundPayloads, K as getRemoteSkillEligibility, L as setCliSessionId, Lr as isInternalMessageChannel, Mn as resolveTtsConfig, Nn as textToSpeech, On as isSilentReplyText, Pn as parseTtsDirectives, Pr as INTERNAL_MESSAGE_CHANNEL, Qn as loadSessionStore, R as runCliAgent, Rr as normalizeMessageChannel, Rt as resolveAgentRoute, St as AGENT_LANE_SUBAGENT, Ti as DEFAULT_MODEL, Tt as hasNonzeroUsage, Ut as formatDiscordUserTag, Vn as createMediaAttachmentCache, Vt as resolveSessionDeliveryTarget, Wn as runCapability, Xn as resolveSessionTranscriptFile, Xt as normalizeOutboundPayloads, Y as resolveSendPolicy, Yn as loadModelCatalog, Yt as formatOutboundPayloadLog, Zn as emitSessionTranscriptUpdate, Zt as normalizeOutboundPayloadsForJson, _i as formatXHighModelHint, _t as registerAgentRunContext, a as normalizeProviderId, ar as evaluateSessionFreshness, b as isDangerousNameMatchingEnabled, bi as supportsXHighThinking, bt as resolveAcpDispatchPolicyError, c as resolveThinkingDefault, ci as buildWorkspaceSkillSnapshot, cr as resolveSessionResetType, di as readConfigFileSnapshotForWrite, dn as getAcpSessionManager, dr as resolveExplicitAgentSessionKey, en as resolveMessageChannelSelection, et as runEmbeddedPiAgent, fi as setRuntimeConfigSnapshot, fn as toAcpRuntimeError, fr as getChannelPlugin, ft as resolveAgentTimeoutMs, gi as formatThinkingLevels, gt as emitAgentEvent, hi as formatCliCommand, ht as clearAgentRunContext, i as normalizeModelRef, ir as resolveSessionKey, l as getAgentRuntimeCommandSecretTargetIds, lr as mergeSessionEntry, mi as ensureAuthProfileStore, mt as normalizeSpawnedRunMetadata, n as isCliProvider, nn as runWithModelFallback, nr as updateSessionStore, nt as resolveBootstrapWarningSignaturesSeen, o as resolveConfiguredModelRef, on as clearBootstrapSnapshotOnSessionRollover, or as resolveChannelResetConfig, pr as normalizeChannelId, pt as formatAgentInternalEventsForPrompt, q as getSkillsSnapshotVersion, qt as buildOutboundSessionContext, r as modelKey, rn as FailoverError, rr as normalizeAccountId, s as resolveDefaultModelForAgent, sr as resolveSessionResetPolicy, t as buildAllowedModelSet, ti as formatErrorMessage, tt as prepareSessionManagerForRun, u as resolveCommandSecretRefsViaGateway, ui as loadConfig, ur as setSessionRuntimeModel, vi as normalizeThinkLevel, vt as resolveAcpSessionCwd, wt as deriveSessionTotalTokens, xt as AGENT_LANE_NESTED, yi as normalizeVerboseLevel, yt as resolveAcpAgentPolicyError, z as clearSessionAuthProfileOverride, zr as resolveMessageChannel } from "./model-selection-BwtTzt3P.js";
import "./fetch-C6mIvaau.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-D9HIf_4v.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-CJPzKXZn.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-D3U4oTPr.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-C96S5v2G.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-DzajJf6s.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-DT2EvS-5.js");
