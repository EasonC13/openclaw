import { p as defaultRuntime, t as createSubsystemLogger } from "./subsystem-DVwhOlEq.js";
import { Ag as loadModelCatalog, An as applyVerboseOverride, Av as formatThinkingLevels, Ba as buildOutboundSessionContext, Bf as emitSessionTranscriptUpdate, Bn as getRemoteSkillEligibility, Bp as isGatewayMessageChannel, C as isCliProvider, Cn as runCliAgent, Di as resolveAcpAgentPolicyError, E as normalizeModelRef, Ei as resolveAcpSessionCwd, Fi as applyModelOverrideToSessionEntry, Ga as normalizeOutboundPayloadsForJson, Gd as isSilentReplyPrefixText, Hf as loadSessionStore, Hg as readConfigFileSnapshotForWrite, Ir as runEmbeddedPiAgent, K as getAgentRuntimeCommandSecretTargetIds, Kd as isSilentReplyText, Kf as updateSessionStore, L as resolveThinkingDefault, Lf as resolveSessionTranscriptFile, Lp as INTERNAL_MESSAGE_CHANNEL, Lr as prepareSessionManagerForRun, Lv as normalizeThinkLevel, M as resolveConfiguredModelRef, Ma as resolveSessionDeliveryTarget, Mi as AGENT_LANE_SUBAGENT, N as resolveDefaultModelForAgent, O as normalizeProviderId, Oi as resolveAcpDispatchPolicyError, Ov as DEFAULT_MODEL, Qi as resolveContextTokensForModel, Rg as loadConfig, Rp as isDeliverableMessageChannel, Sd as toAcpRuntimeError, Si as emitAgentEvent, Sn as setCliSessionId, T as modelKey, Ti as registerAgentRunContext, Ua as formatOutboundPayloadLog, Up as normalizeMessageChannel, Va as deliverOutboundPayloads, Vp as isInternalMessageChannel, Vv as supportsXHighThinking, Wa as normalizeOutboundPayloads, Wg as setRuntimeConfigSnapshot, Wp as resolveMessageChannel, Wr as resolveBootstrapWarningSignaturesSeen, Z as resolveCommandSecretRefsViaGateway, Zu as clearBootstrapSnapshotOnSessionRollover, _i as resolveAgentTimeoutMs, _p as resolveSessionResetPolicy, ep as normalizeAccountId, gp as resolveChannelResetConfig, gr as getSkillsSnapshotVersion, hp as evaluateSessionFreshness, io as resolveMessageChannelSelection, ja as resolveOutboundTarget, ji as AGENT_LANE_NESTED, jv as formatXHighModelHint, kr as resolveSendPolicy, kv as DEFAULT_PROVIDER, mp as resolveSessionKey, p as ensureAuthProfileStore, ra as normalizeReplyPayload, so as runWithModelFallback, uo as FailoverError, vi as formatAgentInternalEventsForPrompt, vp as resolveSessionResetType, wn as clearSessionAuthProfileOverride, wp as resolveExplicitAgentSessionKey, xd as getAcpSessionManager, xi as clearAgentRunContext, xn as getCliSessionId, xp as setSessionRuntimeModel, y as buildAllowedModelSet, yi as normalizeSpawnedRunMetadata, yp as mergeSessionEntry, zv as normalizeVerboseLevel } from "./auth-profiles-Bhj7KY_0.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { D as ensureAgentWorkspace, a as resolveAgentDir, d as resolveAgentWorkspaceDir, h as resolveSessionAgentId, p as resolveEffectiveModelFallbacks, r as listAgentIds, u as resolveAgentSkillsFilter } from "./agent-scope-DBEC2O3x.js";
import { c as normalizeAgentId, l as normalizeMainKey, u as resolveAgentIdFromSessionKey } from "./session-key-GuEQvqMH.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-B3A7AH0T.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BKDaOrHv.js";
import { l as resolveStorePath } from "./paths-QMxjnO9x.js";
import { d as deriveSessionTotalTokens, f as hasNonzeroUsage } from "./session-cost-usage-6HYiRnfr.js";
import { n as createDefaultDeps, t as createOutboundSendDeps } from "./outbound-send-deps-DwzO3Inn.js";
