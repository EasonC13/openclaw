import { d as visibleWidth, u as stripAnsi$1 } from "./subsystem-DBBM_0ww.js";
import { Am as GATEWAY_CLIENT_NAMES, Bh as assertExplicitGatewayAuthModeWhenBothConfigured, Dm as GATEWAY_CLIENT_CAPS, Hs as buildGatewayConnectionDetails, Jv as listThinkingLevelLabels, Ks as resolveExplicitGatewayAuth, Kv as formatThinkingLevels, Lh as resolveConfiguredSecretInputString, Mi as formatRelativeTimestamp, Ni as formatTimeAgo, Ws as ensureExplicitGatewayAuth, b_ as loadConfig, bv as VERSION, cd as listChatCommands, df as formatToolDetail, dp as formatRawAssistantErrorForUi, ey as normalizeUsageDisplay, ff as resolveToolDisplay, km as GATEWAY_CLIENT_MODES, ld as listChatCommandsForConfig, ny as resolveResponseUsageMode, tc as GatewayClient } from "./reply-DCmI6_Pe.js";
import { c as resolveAgentIdByWorkspacePath, f as resolveDefaultAgentId } from "./agent-scope-BwZuo7sQ.js";
import { E as parseAgentSessionKey, c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-DjKQluAa.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-d7ZFrG7U.js";
import { s as formatTokenCount, y as stripLeadingInboundMetadata } from "./session-cost-usage-CUa3Yrhb.js";
