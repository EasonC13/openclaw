...
import { __ as writeConfigFile, p_ as readConfigFileSnapshot } from "./reply-wyWTjlY3.js";
...
async function runOnboardingWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./reply-wyWTjlY3.js").then((n) => n.Et);
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-Cx4FCHuY.js").then((n) => n.t);
		const { logConfigUpdated } = await import("./logging-4-eCRYIV.js").then((n) => n.r);
	...
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-DGrynQA5.js");
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-BuU2xYqA.js").then((n) => n.t);
	const { promptCustomApiConfig } = await import("./onboard-custom-mxJd0qq7.js").then((n) => n.r);
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-u9CnBfq4.js").then((n) => n.t);
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-BgLTi_qE.js").then((n) => n.i);
	...
	const { configureGatewayForOnboarding } = await import("./onboarding.gateway-config-B9F2yblg.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { setupChannels } = await import("./onboard-channels-DSS8ZHNI.js").then((n) => n.n);
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-DbLUFQr1.js").then((n) => n.t);
	...
	await writeConfigFile(nextConfig);
	const { finalizeOnboardingWizard } = await import("./onboarding.finalize-C7LKFsg1.js");
