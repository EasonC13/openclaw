...
import { A as normalizeProviderId, Bf as SYNTHETIC_BASE_URL, C_ as readConfigFileSnapshot, D as modelKey, D_ as writeConfigFile, E as legacyModelKey, Ff as buildQianfanProvider, Gf as VENICE_DEFAULT_MODEL_REF, Gv as DEFAULT_PROVIDER, Hf as SYNTHETIC_MODEL_CATALOG, Hv as normalizeSecretInput, If as buildXiaomiProvider, Iv as resolveOpenClawAgentDir, Jf as HUGGINGFACE_BASE_URL, Kf as VENICE_MODEL_CATALOG, L as resolveModelRefFromString, Lf as TOGETHER_BASE_URL, Mf as XIAOMI_DEFAULT_MODEL_ID, Nf as buildKilocodeProvider, Pf as buildKimiCodingProvider, Rf as TOGETHER_MODEL_CATALOG, S as buildModelAliasIndex, Uf as buildSyntheticModelDefinition, Vf as SYNTHETIC_DEFAULT_MODEL_REF, Wf as VENICE_BASE_URL, Xf as buildHuggingfaceModelDefinition, Yf as HUGGINGFACE_MODEL_CATALOG, ap as buildCloudflareAiGatewayModelDefinition, ip as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, jf as QIANFAN_DEFAULT_MODEL_ID, kv as upsertAuthProfile, np as KILOCODE_BASE_URL, op as resolveCloudflareAiGatewayBaseUrl, qf as buildVeniceModelDefinition, rp as KILOCODE_DEFAULT_MODEL_REF, zf as buildTogetherModelDefinition } from "./reply-DCmI6_Pe.js";
import { F as toAgentModelListLike, r as listAgentIds } from "./agent-scope-BwZuo7sQ.js";
import { c as normalizeAgentId } from "./session-key-DjKQluAa.js";
import { i as coerceSecretRef, t as DEFAULT_SECRET_PROVIDER_ALIAS } from "./types.secrets-d7ZFrG7U.js";
import { t as formatCliCommand } from "./command-format-p_4ya3m0.js";
import { r as isWSLEnv } from "./fetch-v4efc6-X.js";
