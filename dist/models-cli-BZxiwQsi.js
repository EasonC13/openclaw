...
import { $ as resolveCommandSecretRefsViaGateway, $g as resolveSecretRefString, A as normalizeProviderId, Av as ensureAuthProfileStore, B as resolvePluginProviders, C as findNormalizedProviderValue, Cf as hasUsableCustomProviderApiKey, Cv as getShellEnvAppliedKeys, D as modelKey, Df as resolveUsableCustomProviderApiKey, Dv as listProfilesForProvider, E_ as setRuntimeConfigSnapshot, Ef as resolveEnvApiKey, Et as openUrl, F as resolveDefaultModelForAgent, Fv as resolveAuthStorePathForDisplay, Gv as DEFAULT_PROVIDER, Iv as resolveOpenClawAgentDir, K as withProgressTotals, Ka as describeFailoverError, L as resolveModelRefFromString, Ov as setAuthProfileOrder, P as resolveConfiguredModelRef, P_ as parseDurationMs, Qd as resolveModelWithRegistry, Rv as resolveAuthProfileDisplayLabel, S as buildModelAliasIndex, Sf as getCustomProviderApiKey, Tf as resolveAwsSdkEnvVarName, Wv as DEFAULT_MODEL, X as getModelsCommandSecretTargetIds, b_ as loadConfig, bi as formatUsageWindowSummary, c as buildAuthHealthSummary, cp as resolveAuthProfileOrder, ep as isNonSecretApiKeyMarker, j as parseModelRef, kv as upsertAuthProfile, l as formatRemainingShort, lp as resolveProfileUnusableUntilForDisplay, nf as discoverModels, o as maskApiKey, s as DEFAULT_OAUTH_WARN_MS, sp as resolveAuthProfileEligibility, tf as discoverAuthStorage, vi as loadProviderUsageSummary, vr as runEmbeddedPiAgent, w_ as readConfigFileSnapshotForWrite, wf as resolveApiKeyForProvider, wv as shouldEnableShellEnvFallback, xf as shouldSuppressBuiltInModel, xi as resolveUsageProviderId, y_ as createConfigIO, yf as loadModelCatalog } from "./reply-DCmI6_Pe.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-CGpDGoQL.js");
	const { ensureOpenClawModelsJson } = await import("./reply-DCmI6_Pe.js").then((n) => n.bf);
