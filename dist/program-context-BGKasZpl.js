...
const loadValidatedConfigForPluginRegistration = async () => {
	const mod = await import("./reply-DCmI6_Pe.js").then((n) => n.g_);
...
const entries = [
	{
		...
		register: async (program) => {
			(await import("./acp-cli-x01EWenG.js")).registerAcpCli(program);
		}
	},
	{
		name: "gateway",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./gateway-cli-BA1ux0H9.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./daemon-cli-DBqIwkgU.js").then((n) => n.t)).registerDaemonCli(program);
		}
	},
	{
		name: "logs",
		...
		register: async (program) => {
			(await import("./logs-cli-pwjvWVAR.js")).registerLogsCli(program);
		}
	},
	{
		name: "system",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./system-cli-bnvF-HAe.js")).registerSystemCli(program);
		}
	},
	{
		name: "models",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./models-cli-BZxiwQsi.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./exec-approvals-cli-uTIz_JMx.js")).registerExecApprovalsCli(program);
		}
	},
	{
		name: "nodes",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./nodes-cli-BAqyVJMy.js")).registerNodesCli(program);
		}
	},
	{
		name: "devices",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./devices-cli-mk89XgsB.js")).registerDevicesCli(program);
		}
	},
	{
		name: "node",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./node-cli-YcWirxO-.js")).registerNodeCli(program);
		}
	},
	{
		name: "sandbox",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./sandbox-cli-YP2j-3NG.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./tui-cli-BWySwqdt.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./cron-cli-Bi3MILJm.js")).registerCronCli(program);
		}
	},
	{
		name: "dns",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./dns-cli-mioZsfbB.js")).registerDnsCli(program);
		}
	},
	{
		name: "docs",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./docs-cli-CN2lnl1S.js")).registerDocsCli(program);
		}
	},
	{
		name: "hooks",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./hooks-cli-B-UoYvcW.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./webhooks-cli-aHwXEsZQ.js")).registerWebhooksCli(program);
		}
	},
	{
		name: "qr",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./qr-cli-BxjAA-gC.js")).registerQrCli(program);
		}
	},
	{
		name: "clawbot",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./clawbot-cli-oaQfOajq.js")).registerClawbotCli(program);
		}
	},
	{
		name: "pairing",
		...
		hasSubcommands: true,
		register: async (program) => {
			const { registerPluginCliCommands } = await import("./cli-Ge-8DZ0n.js");
			const config = await loadValidatedConfigForPluginRegistration();
			if (config) registerPluginCliCommands(program, config);
			(await import("./pairing-cli-DQrKoQhJ.js")).registerPairingCli(program);
		}
	},
	{
		name: "plugins",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./plugins-cli-DLir09qY.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-Ge-8DZ0n.js");
			const config = await loadValidatedConfigForPluginRegistration();
			if (config) registerPluginCliCommands(program, config);
		}
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./channels-cli-Dk8-wVM9.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./directory-cli-DRFxygqh.js")).registerDirectoryCli(program);
		}
	},
	{
		name: "security",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./security-cli-PlGRnrW2.js")).registerSecurityCli(program);
		}
	},
	{
		name: "secrets",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./secrets-cli-NW0OkNBH.js")).registerSecretsCli(program);
		}
	},
	{
		name: "skills",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./skills-cli-DvnrC-MA.js")).registerSkillsCli(program);
		}
	},
	{
		name: "update",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./update-cli-DmKpN-FH.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./completion-cli-nEVXlAZL.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-DjVLJRKE.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-CSSEdjSe.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.configure-BMSecr7w.js")).registerConfigureCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./config-cli-BC1KFOj4.js")).registerConfigCli(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.backup-wC3viNrE.js")).registerBackupCommand(program);
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-Bjz-WrKk.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.message-IhVrOCUW.js")).registerMessageCommands(program, ctx);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./reply-DCmI6_Pe.js").then((n) => n.U)).registerMemoryCli(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.agent-CK_IVzi-.js")).registerAgentCommands(program, { agentChannelOptions: ctx.agentChannelOptions });
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.status-health-sessions-BAMBM_3E.js")).registerStatusHealthSessionsCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./browser-cli-F1arEwGq.js")).registerBrowserCli(program);
		}
	}
];
